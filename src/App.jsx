...
const VIEWS = [
  ...
  // Scenarios is a first-round tool; it is hidden once the first round is in the
  // rear-view (see `groupStageArchived`). The nav wraps to a second row on mobile
  // after Groups.
...
const HIDEABLE_STAGES = [
  { stage: 'R1', title: 'First round', noun: 'first-round game' },
  { stage: 'R2', title: 'Second round', noun: 'second-round game' },
  { stage: 'Class', title: 'Classification', noun: 'classification game' },
...
export default function App() {
  ...
  const displayMatches = useMemo(
    () => applyLive(resolveBracket(matches), unclaimedLive(live, GAMES)),
    [matches, live],
  )
    ...
    <div className={`app${navAway ? ' nav-away' : ''}`}>
      ...
      <footer className="app-footer">
        ...
        <p className="disclaimer">
          ...
          “FIBA Basketball World Cup”, team, broadcaster, and tournament names are trademarks of
        ...
        <p className="credit">
          ...
          ·{' '}
          <a
            href="https://github.com/ismayc/fiba-mens-world-cup-viewer"
            target="_blank"
