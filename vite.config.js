...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      // Only src/** here. This edition's /calendar.ics is a STATIC file built by
      // scripts/build-calendar.mjs (scripts/** sits outside the gate family-wide),
      // not a Netlify function, so there is no runtime endpoint to cover. The sibling
      // live viewers keep 'netlify/functions/**' in this list because their feed IS a
